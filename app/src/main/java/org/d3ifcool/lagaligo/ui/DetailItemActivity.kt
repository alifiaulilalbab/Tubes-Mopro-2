        ...
        when (type) {
            ...
            MainActivity.EXTRA_KULINER -> {
                ...
                binding.tvAlamat.text =
                    StringBuilder(getString(R.string.alamat)).append(dataKuliner.alamatKuliner)
                binding.tvKontak.text =
                    StringBuilder(getString(R.string.kontak)).append(dataKuliner.kontak)
